...
##   \VV/  #                                                               ##
##    //   #  Makefile automagically generated by coq_makefile V8.3-rc1    ##
#############################################################################
...
VFILES:=AxiomaticLambdaBisimulationExample.v\
  Bisimulation.v\
  CoPeanoCoalgebra.v\
  ExtensionalFunctor.v\
  IntensionalLambdaBisimulation.v\
...
install:
	...
	(for i in $(VOFILES); do \
	 install -d `dirname $(COQLIB)/user-contrib/Coalgebras/$$i`; \
	 install $$i $(COQLIB)/user-contrib/Coalgebras/$$i; \
	 done)
